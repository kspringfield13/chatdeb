...
def layout1(content, outfile):
    ...
    fig.suptitle(content["title"], fontsize=16, y=0.95)
    fig.text(0.5, 0.90, content["big_number"], ha="center", fontsize=14)
...
def layout2(content, outfile):
    ...
    fig.suptitle(content["title"], fontsize=16, y=0.98)
    ...
    ax_big.axis("off")
    ax_big.text(0.5, 0.5, content["big_number"], ha="center", va="center", fontsize=14)
...
def layout3(content, outfile):
    ...
    ax_title.axis("off")
    ax_title.text(0, 0.5, content["title"], ha="left", va="center", fontsize=16)
